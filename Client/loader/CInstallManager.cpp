...
namespace
{
    ...
    void UpdateSettingsForReportLog()
    {
        ...
        SetApplicationSetting("customized-sa-files-using", SString("%d", 1));
        SetApplicationSetting("customized-sa-files-show", SString("%d", 1));
        SetApplicationSetting("customized-sa-files-request", SString("%d", 1));
    }
